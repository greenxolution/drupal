...
?>
    ...
    <?php if(isset($customize['font_family_second'])  && $customize['font_family_second'] != '---'){ ?>
        .pager ul.pager__items > li a,header .header-button a,.gva-user-region .user-content,.page-user-login form .form-item label, .page-user-register form .form-item label, .page-user-pass form .form-item label,
        ...
        .navigation .gva_menu > li > a,.navigation .gva_menu .megamenu > .sub-menu > li > ul.sub-menu li,.navigation .gva_menu .sub-menu > li > a,.tags-list .item-list > ul > li a,.gsc-icon-box .highlight_content .title,.gsc-icon-box-color .content-inner .box-title,.milestone-block.position-icon-top .milestone-text,.milestone-block.position-icon-top-2 .milestone-text,
        ...
        .gva-offcanvas-mobile .gva-navigation .gva_menu > li > a,#listing-main-map .leaflet-popup-content-wrapper .leaflet-popup-content .gva-map-content-popup .content-inner .title,.gva-listings-map-page .map-action,
        .gva-listings-map-page .map-action-mobile,.gva-listings-full-page-2 .map-action,.views-exposed-form .form-item input[type='text']:not(.chosen-search-input), .views-exposed-form .form-item input[type='search'], .views-exposed-form .form-item input[type='password'], .views-exposed-form .form-item input[type='email'], .views-exposed-form .form-item textarea, .views-exposed-form .form-item select,
    ...
    <?php if(isset($customize['body_bg_image'])  && $customize['body_bg_image']){ ?>
        body{
            background-image:url('<?php echo \Drupal::service('extension.list.theme')->getPath('gavias_lozin') .'/images/patterns/'. $customize['body_bg_image']; ?>');
        }
    <?php } ?> 
   ...
   <?php //===================Menu=================== ?>
    ...
    <?php if(isset($customize['menu_color_link']) && $customize['menu_color_link']){ ?>
        .main-menu ul.gva_menu > li > a, .main-menu ul.gva_menu > li > a:after, .main-menu ul.gva_menu > li > a:before, .main-menu ul.gva_menu > li > a .icaret{
    ...
    <?php if(isset($customize['menu_color_link_hover']) && $customize['menu_color_link_hover']){ ?>
        .main-menu ul.gva_menu > li > a:hover, .main-menu ul.gva_menu > li > a:after, .main-menu ul.gva_menu > li > a:before, .main-menu ul.gva_menu > li > a .icaret{
