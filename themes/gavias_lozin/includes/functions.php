...
function gavias_lozin_base_url(){
  global $base_url;
  $theme_path = \Drupal::service('extension.list.theme')->getPath('gavias_lozin');
...
function gavias_lozin_preprocess_node(&$variables) {
  ...
  if ($variables['node']->getType() == 'article') {
    ...
    $variables['theme_uri'] = base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_lozin');
  }
}
