...
function gavias_lozin_form_views_exposed_form_alter(array &$form) {
 ...
 */
function gavias_lozin_form_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id) {
