   ...
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       ob_start();
         ...
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_lozin')) ?>/vendor/gmap3.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_lozin')) ?>/vendor/jquery.ui.map.min.js"></script>
